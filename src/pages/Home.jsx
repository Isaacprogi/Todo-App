...
const Home = () => {
    ...
    const todoList = (() => {
        return (switchList && editing) ? <div  className='w-full h-full overflow-auto flex flex-col'>
                ...
                <textarea  type="text" ref={editInput}  className='flex-auto min-h-[10rem] bg-gray-100 resize-none p-2 outline-none' />
    ...
    const eventList = (() => {
        ...
        <textarea  type="text" ref={editInput}  className='flex-1 p-2 resize-none bg-gray-100 outline-none' />
        ...
        <div className=" h-full w-full grid md:grid-cols-medium bg-blue-100 gap-3 lg:p-1 lg:grid-cols-large overflow-hidden">
            ...
            <div className="w-full h-full lg:rounded-md flex flex-col overflow-hidden ">
                <div className="nav flex-none bg-yellow-400 relative w-full h-[10rem] ">
                    <NavBar switchList={switchList} setSwitchList={setSwitchList} search={search} handleFilters={handleFilters}  nav={nav} setNav={setNav} handleRotate={handleRotate} rotate={rotate} />
                </div>
